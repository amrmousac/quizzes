...
class SingleGroupWidget extends StatelessWidget {
   ...
   final String ? numOfGroup;
  const SingleGroupWidget({super.key, @required this.groupName, @required this.numOfGroup});
                ...
                child: Container(
                  ...
                  child:  Column(
                    ...
                    children: [
                      ...
                      Text("#"+ numOfGroup!,style: TextStyle(color: Colors.black  )),
                    ],
                  ),
